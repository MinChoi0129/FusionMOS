...
def gen_depth_data(scan_folder, dst_folder, normalize=False):
    ...
    for idx in range(len(scan_paths)):
        ...
        proj_vertex = range_projection(
            current_vertex, fov_up=3, fov_down=-25, proj_H=64, proj_W=2048, max_range=50
        )
        ...
        color_img = cv2.applyColorMap(
            proj_range.astype(np.uint8), get_mpl_colormap("viridis")
...
if __name__ == "__main__":
    ...
    scan_folder = "/home/ssd/kitti/dataset/sequences/05/velodyne"
