...
class MFMOS(nn.Module):
    def __init__(
        self, nclasses, movable_nclasses, params, num_batch=None, point_refine=None
    ):
        ...
        self.resBlock1 = ResBlock(
            32, 2 * 32, 0.2, pooling=True, drop_out=False, kernel_size=(2, 4)
        )
        self.resBlock2 = ResBlock(
            2 * 32, 2 * 2 * 32, 0.2, pooling=True, kernel_size=(2, 4)
        )
        self.resBlock3 = ResBlock(
            2 * 2 * 32, 2 * 4 * 32, 0.2, pooling=True, kernel_size=(2, 4)
        )
        self.resBlock4 = ResBlock(
            2 * 4 * 32, 2 * 4 * 32, 0.2, pooling=True, kernel_size=(2, 4)
        )
        self.resBlock5 = ResBlock(
            2 * 4 * 32, 2 * 4 * 32, 0.2, pooling=False, kernel_size=(2, 4)
        )
        ...
        self.RI_resBlock5 = ResBlock(
            2 * 4 * 32, 4 * 4 * 32, 0.2, pooling=False, kernel_size=(2, 4)
        )
    ...
    def forward(self, x):
        ...
        *_downCntx:[bs, .., h, w]
        ...
        Range_down0c, Range_down0b = self.RI_resBlock1(
            downCntx
        )  # (64, 32, 1024), (64, 64, 2048)
        Range_down1c, Range_down1b = self.RI_resBlock2(
            Range_down0c
        )  # (128, 16, 512), (128, 32, 1024)
        Range_down2c, Range_down2b = self.RI_resBlock3(
            Range_down1c
        )  # (256, 8, 256) , (256, 16, 512)
        Range_down3c, Range_down3b = self.RI_resBlock4(
            Range_down2c
        )  # (256, 4, 128) , (256, 8, 256)
